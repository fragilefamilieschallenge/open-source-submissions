...
# replaces missing values with the median in each col. Makes minor adjustments - if column has
# only one value other than NA, will turn feature into a binary feature. 
# -------------------------------------------------------------------------------------------------
...
## IMPUTATION: replace missing values with median value of each column 
data <- f_median(data)
